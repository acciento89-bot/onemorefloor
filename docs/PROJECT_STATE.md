...
r1.1 restores gameplay-distance midtone separation for dark Wanderer/enemy materials without geometry, rig, animation or gameplay-authority changes. Existing rim/fill lights are reused. Enemy material response is applied after inherited `configure_enemy()`; Skeleton stays locked.
...
## Extra hardening
v89 now validates runtime Necromancer + Skeleton final-write ordering. This changes no production values. At the final pre-documentation observation its newest Actions job remained queued behind broad historical workflow fanout; keep it pending until it actually runs.

## Locked parents
v1.63 `7262f42002aeeba338559190e8a87a616329ec54`; v1.62 UI `71c8ecec5387400af7ef1c4bd29a3f87f9323d17`; v1.61 Combat Presentation `bb367aad35338dd6d32fbdf7d4de4208efef2ad0`; v1.60 Authored 3D `3e567bf409a8492a55f672b226ce9ce81c16780f` with Wanderer safe point `00a78086d47b06093c1c7554c2713067f3def132` and Hood r11 `4f82a5aeb717a088747eb31849b2d2d97340ba27`.
