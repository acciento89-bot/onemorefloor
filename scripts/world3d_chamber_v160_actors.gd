...
const ActorFactoryV160 = preload("res://scripts/world3d_actor_factory_v160_wanderer_hood_r11.gd")
const ACTOR_PRESENTATION_VERSION := "1.60-character-quality-r8.1-hood-r11-enemy-r5.1"
