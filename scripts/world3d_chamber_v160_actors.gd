...
const ActorFactoryV160 = preload("res://scripts/world3d_actor_factory_v160_character_quality_r7.gd")
const ACTOR_PRESENTATION_VERSION := "1.60-character-quality-r7"
