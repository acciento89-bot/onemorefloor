...
# ONE MORE FLOOR v1.65 r1.3 — active Environment Surface & Depth top layer.
# Keeps the accepted v1.64 character-lighting + v1.63 combat/UI/gameplay stack
# and swaps only the 3D presentation world to the restrained v1.65 final pass.

const EnvironmentDepthWorldV165 = preload("res://scripts/world3d_chamber_v165_environment_depth_r13.gd")
const V86_FEATURE := "1.65-environment-depth-r1.3"
