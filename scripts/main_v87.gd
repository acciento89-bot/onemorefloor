...
func _ready() -> void:
	super._ready()
	if telemetry != null:
		telemetry.event("character_form_v166_ready", _v87_character_form_snapshot())
...
func _v52_create_world_viewport() -> void:
	...
	v52_world_root = CharacterFormWorldV166.new()
	v52_world_root.name = "CharacterForm3DRealmWorld"
	v52_world_viewport.add_child(v52_world_root)
	v52_world_root.set_active(false)

func _v87_character_form_ready() -> bool:
	return _v86_environment_depth_ready() \
		and v52_world_root != null \
		and v52_world_root.has_method("production_character_form_ready") \
		and bool(v52_world_root.call("production_character_form_ready"))

func _v87_character_form_snapshot() -> Dictionary:
	...
	return {
		"ready": _v87_character_form_ready(),
		"feature": V87_FEATURE,
		"environment_r13_preserved": _v86_environment_depth_ready(),
