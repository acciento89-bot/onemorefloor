...
# realm-dressing + production-floor + focal/material + actor layer to Floors 1-50.
...
const AuthoredTowerWorldV160 = preload("res://scripts/world3d_chamber_v160_actors.gd")
